...
\hyperref[11-log-into-your-aws-instance]{1.1 Log into your AWS instance}\\
\hyperref[12-creating-directories-and-moving-around-on-the-command-line]{1.2 Creating directories and moving around on the command line}\\
\hyperref[13-use-wget-to-download-files]{1.3 Use wget to download files}\\
\hyperref[14-move-these-files-to-the-directories]{1.4 Move these files to the directories}\\
\href{s\#15-zip-and-unzip-these-files}{1.5 Zip and unzip these files}\\
\hyperref[16-create-new-tar-archive-of-files]{1.6 Create new tar archive of files}\\
\hyperref[17-unzip-tar-archive]{1.7 Unzip tar archive}\\
\hyperref[18-look-at-fasta-and-fastq-files-with-less]{1.8 Look at fasta and fastq files with less}\\
\hyperref[19-installing-programs-to-the-server]{1.9 Installing programs to the server}\\
\hyperref[110-conda-environments]{1.10 Conda environments}\\
\hyperref[111-install-fastqc-and-multiqc]{1.11 Install fastqc and multiqc}\\
\hyperref[112-perform-quality-control-on-fastq-files]{1.12 Perform quality control on fastq files}\\
\hyperref[113-htop---looking-at-the-number-of-processes-we-have-available-or-running]{1.13 htop - looking at the number of processes we have available or running}\\
\hyperref[114-back-to-the-quality-control]{1.14 Back to the quality control}\\
\href{s\#115-quality-control-on-the-data-that-well-be-using}{1.15 Quality control on the data that we'll be using}\\
\hyperref[116-install-qiime2]{1.16 Install QIIME2}\\
