...
1.  [16S analysis](#1-16S)
    1.  [16S First steps](#11-16S-First-steps)
    2.  [16S Denoising reads into amplicon sequence variants](#12-16S-denoising-the-reads-into-amplicon-sequence-variants)
    3.  [16S Assign taxonomy to ASVs](#13-16S-assign-taxonomy-to-asvs)
    4.  [16S Filtering resultant table](#14-16S-filtering-resultant-table)
    5.  [16S Answers](#16S-Answers)
2. [18S analysis](#2-18S)
    1. [18S First steps](#21-18S-First-steps)
    2. [18S Denoising reads into amplicon sequence variants](#22-18S-denoising-the-reads-into-amplicon-sequence-variants)
    3. [18S Assign taxonomy to ASVs](#23-18S-assign-taxonomy-to-asvs)
    4. [18S Filtering resultant table](#24-18S-filtering-resultant-table)
    5. [18S Answers](#18S-Answers)
3. [ITS analysis](#3-ITS)
    1. [ITS First steps](#31-ITS-First-steps)
    2. [ITS Denoising reads into amplicon sequence variants](#32-ITS-denoising-the-reads-into-amplicon-sequence-variants)
    3. [ITS Assign taxonomy to ASVs](#33-ITS-assign-taxonomy-to-asvs)
    4. [ITS Filtering resultant table](#34-ITS-filtering-resultant-table)
    5. [ITS Answers](#ITS-Answers)
